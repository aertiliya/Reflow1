...
class DiTInference:
    def __init__(self, checkpoint_path, device='cuda'):
        ...
        # Initialize DiT CurveVelB
        print("Initializing DiT CurveVelB...")
        self.model = DiT(
        ...
        if 'ema' in checkpoint:
            ...
            print("Loading CurveVelB weights...")
            self.model.load_state_dict(checkpoint['CurveVelB'])
    ...
    def sample(self, num_samples=16, class_labels=None, cfg_scale=3.0, 
        ...
        """
        Sample images from the CurveVelB.
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, required=True,
                       help='Path to CurveVelB checkpoint')
